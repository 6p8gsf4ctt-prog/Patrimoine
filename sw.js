const CACHE='patrimoine-v5.2';
const ASSETS=['./','./index.html','./styles.css?v=52','./app.js?v=52','./manifest.webmanifest','./assets/seed.json?v=40','./assets/icons/icon-192.png','./assets/icons/icon-512.png'];
