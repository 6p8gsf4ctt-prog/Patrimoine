const CACHE='patrimoine-v1.0.0';
const ASSETS=['./','./index.html','./styles.css','./app.js','./manifest.webmanifest','./assets/seed.json','./assets/icons/icon-192.png','./assets/icons/icon-512.png'];
