const CACHE='patrimoine-v2-20';
const ASSETS=['./','./index.html','./app.js?v=20','./styles.css?v=20','./manifest.webmanifest','./assets/seed.json?v=20','./assets/icons/icon-192.png','./assets/icons/icon-512.png'];
